...
"confirmation": "<confirmation message that we will start research>"
...
"question": "",
"confirmation": "<acknowledgement message that you will now start research based on the provided information>"

For the confirmation message when no clarification is needed:
