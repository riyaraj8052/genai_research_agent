...
from A05_research_agent_schema import ResearcherState, ResearcherOutputState
from A04_utils import model_config, tavily_search, get_today_str, think_tool
from A01_prompts import research_agent_prompt, compress_research_system_prompt, compress_research_human_message
...
# Create a custom tool_node instead of using langgraph.prebuilt ToolNode
...
research_agent_builder.add_node("researcher", researcher)
...
research_agent_builder.add_edge(START, "researcher")
...
research_agent_builder.add_edge("tool_node", "researcher") # Loop back for more research
